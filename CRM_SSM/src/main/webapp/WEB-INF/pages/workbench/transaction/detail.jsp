...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		<div class="page-header">
			<h3>${tranList.customerId}-${tranList.name} <small>￥${tranList.money}</small></h3>
		</div>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stageList}" var="stage">
			<%--如果stage就是交易所处阶段，组图标显示为map-marker，颜色显示为绿色--%>
			...
			<%--如果stage处在当前交易阶段前面，图标显示为ok-circle，颜色为绿色--%>
			...
			<%--如果stage处在当前交易的后面，图标显示为record，颜色为黑色--%>
			<c:if test="${tranList.orderNo<stage.orderNo}">
	...
	<div style="position: relative; top: 0px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			...
			<div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${tranList.customerId}-${tranList.name}</b></div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${tranList.possibility}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 60px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${tranList.createBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${tranList.createTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		<div style="position: relative; left: 40px; height: 30px; top: 70px;">
			<div style="width: 300px; color: gray;">修改者</div>
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${tranList.editBy}&nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;">${tranList.editTime}</small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
		...
		<c:forEach items="${trList}" var="tr">
			<div class="remarkDiv" id="div_${tr.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${tranList.customerId}-${tranList.name}</b> <small style="color: gray;"> ${tr.editFlag=="0"?tr.createTime:tr.editTime} 由${tr.editFlag=="0"?tr.createBy:tr.editBy}${tr.editFlag=="0"?'创建':'修改'}</small>
